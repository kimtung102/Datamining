...
public class Wine {
    ...
    public Wine(float fixedAcidity, float volatileAcidity, float citricAcid, float residualSugar,
            float chlorides, float freeSulfurDioxide, float totalSulfurDioxide,
    ...
    public Instance getInstanceData() {
        FastVector atts;
        FastVector attVals;
        Instances data;
        double[] vals;
